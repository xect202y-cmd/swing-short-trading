...
def test_settle_matches_bar_by_date():
    ...
    results, rows, missing = _settle_scalp_plan(plan, dfs, fee_bps=1.5, slip_bps=5.0, models=("v1",))
...
def test_settle_no_bar_returns_none():
    ...
    results, rows, missing = _settle_scalp_plan(plan, {}, fee_bps=1.5, slip_bps=5.0, models=("v1",))
